...
Os LiveScripts MATLAB foram traduzidos para m-files, para viabilizar sua execução em versões anteriores do MATLAB. À medida em que a biblioteca em Python RoboPy ganha maturidade, todos os m-files serão disponibilizados em notebooks Jupyter.
